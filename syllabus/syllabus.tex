...
% Week-6-Tue.ipynb
%     into, Fourier analysis, gatspy, Lomb-Scargle
% Week-6-Thu.ipynb
%     stochastic time series, DRW, power-law PSD
%   -> HW6 from s17-private (LINEAR periodic variables)

\item WEEK  7 (starting May 8): Dimensionality reduction and regression.
% Week-8-Tue.ipynb
%                                        REGULARIZATION??? 
% Week-8-Thu.ipynb
%     total LSQ, linear basis function regression 
%   -> HW8 from s17-private  (PCA in 4D LINEAR-based space, age-color regression) 
...
% Week-9-Thu.ipynb
% 
%   -> HW9 from s17-private  (KDE in CMD) 

\item WEEK  9 (starting May 22):  Density estimation and clustering.
%  take GMM from the end of Week-5-Thu.ipynb and expand
%  add something else for Thu 

\item WEEK  10 (starting May 29):  Unsupervised and supervised classification.
% Week-10-Tue.ipynb
%     clustering (very short!) 
% Week-10-Thu.ipynb
%     supervised classification (needs more work!) 
%   -> NO homework!  
